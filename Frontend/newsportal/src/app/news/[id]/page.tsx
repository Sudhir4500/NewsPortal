...
import RelatedCategoryNews from '@/app/components/features/RelatedCategoryNews';
import Tags from '@/app/components/features/Tags';
import { formatDate } from '@/utils/formatDate';
import Link from 'next/link';
import { Suspense } from 'react';
import NewsDetailSkeleton from '@/app/components/loading/NewsDetailSkeleton';
...
async function NewsContent({ id }: { id: string }) {
  ...
  try {
    news = await apiGet<News>(`/news/${id}/`);
    comments = await apiGet<Comment[]>(`/comments/?news_id=${id}`);
  } catch (error: any) {
